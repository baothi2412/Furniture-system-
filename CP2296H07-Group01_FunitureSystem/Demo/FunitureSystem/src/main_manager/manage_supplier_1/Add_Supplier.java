...
public class Add_Supplier extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Add_Supplier1
     */
    public Add_Supplier() {
        initComponents(); 
    ...
    private void initComponents() {
        ...
        txtID.setBounds(250, 300, 259, 30);
        ...
        txtPhone.setBounds(250, 420, 260, 30);
        ...
        btnAddAccept.setBounds(290, 460, 72, 30);
    ...
    private void btnAddAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddAcceptActionPerformed
        ...
        if (id.isEmpty() || name.isEmpty() || address.isEmpty() || phone.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please enter full information to add supplier!!");
        } else {
            //Check ID
            boolean temp = true;
            ...
            if (temp) {
                ...
                if (!checkID) {
                    JOptionPane.showMessageDialog(this, "Error! Supplier ID is duplicate.","Error", JOptionPane.ERROR_MESSAGE);
                } else {
                    mnSupp.addSupplier(id, name, address, phone);
                    JOptionPane.showMessageDialog(this, "Add New Supplier Successfully!", "Message", JOptionPane.INFORMATION_MESSAGE);
                    txtID.setText("");
                    txtName.setText("");
                    txtAddress.setText("");
                    txtPhone.setText("");
