 ...
 * @author Duy Nguyen
 */
public class Delete_Warehouse extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(140, 380, 90, 16);
        ...
        txtID.setBounds(250, 370, 259, 30);
        ...
        btnDeleteAccept.setBounds(290, 420, 72, 30);
        ...
        btnCancel.setBounds(400, 420, 72, 30);
    ...
    private void btnDeleteAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteAcceptActionPerformed
        ...
        if (id.isEmpty()) {
            ...
            if (temp) {
                ...
                if (checkID) {
                    JOptionPane.showMessageDialog(this, "Error! Warehouse ID must exist in the table to delete.", "Error", JOptionPane.ERROR_MESSAGE);
                } else {
                    mnWare.deleteWarehouse(id);
                    JOptionPane.showMessageDialog(this, "Delete Warehouse Successfully!");
                    Delete_Warehouse deleteWare = new Delete_Warehouse();
                    this.dispose();
                    deleteWare.show();
                }
    ...
    private void tbWarehouseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbWarehouseMouseClicked
        DefaultTableModel model = (DefaultTableModel)tbWarehouse.getModel();
        String tbID = model.getValueAt(tbWarehouse.getSelectedRow(), 0).toString();
        txtID.setText(tbID);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Delete_Warehouse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Delete_Warehouse().setVisible(true);
            }
        });
    }
