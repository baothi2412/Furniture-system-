...
public class ChangePwdStaff extends javax.swing.JFrame {
    Connection conn = MyConnection.getConnection();
    Statement stm;
    ResultSet rs;
    public ChangePwdStaff() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (user.isEmpty() || oldP.isEmpty() || newP.isEmpty() || cfP.isEmpty()) {
            ...
            try {
                String sql1 = "select * from Staff where Username = '"+user+"'";
                ...
                while(rs.next()) {
                    if (!oldP.equals(rs.getString("Password"))) {
                        ...
                        String sql2 = "update Staff set Password = '"+newP+"' where Username = '"+user+"'";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChangePwdStaff().setVisible(true);
            }
        });
    }
